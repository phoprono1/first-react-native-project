...
const Create = () => {
  ...
  const submit = async () => {
    ...
    try {
      await createVideo({
        ...form,
        userId: user ? user.$id : '', // Ensure user is not null before accessing $id
      });
  ...
  return (
    <SafeAreaView className='bg-primary h-full'>
      <ScrollView className='px-4 my-6'>
        ...
        <CustomButton title={'Submit & Publish'} handlePress={submit} containerStyles={undefined} textStyles={undefined} isLoading={false}        
        />
