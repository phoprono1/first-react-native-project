...
const Home = () => {
  ...
  const { data: posts, refetch } = useAppwrite<Document[]>(getAllPosts);
  const { data: latestPosts } = useAppwrite<Document[]>(getLatestPosts);
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View className='my-6 px-4 space-y-6'>
            ...
            <SearchInput title={''} value={undefined} placeholder={undefined} handleChangeText={undefined} otherStyles={undefined} keyboardType={undefined} initialQuery={''} />
